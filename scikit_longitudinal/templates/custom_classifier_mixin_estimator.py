...
class CustomClassifierMixinEstimator(BaseEstimator, ClassifierMixin, EnforceOverrides):
    ...
    Methods:
        ...
        cannot be overriden - predict(X): Calls the _predict method, automatically checking X before calling.
        needs to be overriden - _fit(X, y=None): To be implemented by subclasses, contains the actual fitting logic.
        needs to be overriden -  _predict(X): To be implemented by subclasses, contains the actual prediction logic.
    """
