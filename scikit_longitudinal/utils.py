...
from scikit_longitudinal.estimators.tree import LexicoRFClassifier, LexicoDecisionTreeClassifier  # pragma: no cover
...
def save_trees_graphviz(
    ...
    """
    if isinstance(model, (RandomForestClassifier, LexicoRFClassifier)):
