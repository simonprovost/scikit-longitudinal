...
???+ note "Separate Waves (SepWav)"
    **Paper:** Provost, S. and Freitas, A.A. (2025). *A New Longitudinal Classification Method Based on Stacking Predictions for Separate Time Points*. In *AI-2025* (pp. 165–178). [Read the paper (DOI)](https://doi.org/10.1007/978-3-032-11402-0_12). Dataset source: [ELSA](https://www.elsa-project.ac.uk/).
