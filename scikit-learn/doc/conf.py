...
from sklearn_fork.externals._packaging.version import parse
...
parsed_version = parse(sklearn_fork.__version__)
...
if parsed_version.is_postrelease:
    ...
    release = sklearn_fork.__version__
...
def notebook_modification_function(notebook_content, notebook_filename):
    ...
    message = (
        ...
        " will take a lot longer than usual, for example the first"
        "`import sklearn_fork` can"
...
sphinx_gallery_conf = {
    "doc_module": "sklearn_fork",
    "backreferences_dir": os.path.join("modules", "generated"),
    "show_memory": False,
    "reference_url": {"sklearn_fork": None},
...
def generate_min_dependency_table(app):
    ...
    output = StringIO()
    output.write(" ".join(["=" * package_header_len, "=" * version_header_len, "=" * tags_header_len]))
    output.write("\n")
    dependency_title = "Dependency"
    version_title = "Minimum Version"
    tags_title = "Purpose"

    output.write(f"{dependency_title:<{package_header_len}} {version_title:<{version_header_len}} {tags_title}\n")

    output.write(" ".join(["=" * package_header_len, "=" * version_header_len, "=" * tags_header_len]))
    output.write("\n")

    for package, (version, tags) in dependent_packages.items():
        output.write(f"{package:<{package_header_len}} {version:<{version_header_len}} {tags}\n")
...
linkcode_resolve = make_linkcode_resolve(
    "sklearn_fork",
    "https://github.com/scikit-learn/scikit-learn/blob/{revision}/{package}/{path}#L{lineno}",
)
...
autosummary_filename_map = {
    "sklearn_fork.cluster.dbscan": "dbscan-function",
    "sklearn_fork.covariance.oas": "oas-function",
    "sklearn_fork.decomposition.fastica": "fastica-function",
}
