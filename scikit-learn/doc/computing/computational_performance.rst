...
For :mod:`sklearn_fork.linear_model` (e.g. Lasso, ElasticNet,
...
For the :mod:`sklearn_fork.svm` family of algorithms with a non-linear kernel,
...
For :mod:`sklearn_fork.ensemble` of trees (e.g. RandomForest, GBT,
...
memory to 128 MiB::
  ...
  >>> import sklearn_fork
  >>> with sklearn_fork.config_context(working_memory=128):
