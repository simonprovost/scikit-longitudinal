...
<sklearn_fork.base.ClassifierMixin>`.
...
.. topic:: Data transformation with held out data
    ...
    A :class:`Pipeline <sklearn_fork.pipeline.Pipeline>` makes it easier to compose
...
:class:`KFold`.
  ...
  >>> from sklearn_fork.model_selection import StratifiedKFold, KFold
  >>> import numpy as np
...
:func:`~sklearn_fork.model_selection.permutation_test_score` offers another way
...
:func:`~sklearn_fork.model_selection.permutation_test_score` generates a null
...
samples.
:func:`~sklearn_fork.model_selection.permutation_test_score` provides information
...
Finally, :func:`~sklearn_fork.model_selection.permutation_test_score` is computed
