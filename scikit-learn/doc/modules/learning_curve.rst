...
:class:`~sklearn_fork.model_selection.LearningCurveDisplay` will be easier to use.
You can use the method
:meth:`~sklearn_fork.model_selection.LearningCurveDisplay.from_estimator` similarly
