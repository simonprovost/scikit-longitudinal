...
Oracle Shrinkage Approximating estimator :class:`sklearn_fork.covariance.OAS`
...
:mod:`sklearn_fork.covariance` module.
...
:class:`~sklearn_fork.discriminant_analysis.LinearDiscriminantAnalysis`, and it is
the only available solver for
:class:`~sklearn_fork.discriminant_analysis.QuadraticDiscriminantAnalysis`.
