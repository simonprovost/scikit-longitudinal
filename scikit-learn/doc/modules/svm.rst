...
.. note::
  ...
  via the :class:`~sklearn_fork.calibration.CalibratedClassifierCV` (see
  ...
  :class:`~sklearn_fork.calibration.CalibratedClassifierCV`.
...
=====================
  ...
  * **Avoiding data copy**: For :class:`SVC`, :class:`SVR`, :class:`NuSVC` and
    ...
    <sklearn_fork.linear_model.LogisticRegression>`) any input passed as a numpy
    ...
    <sklearn_fork.linear_model.SGDClassifier>` class instead.  The objective
  ...
  * Support Vector Machine algorithms are not scale invariant, so **it
    ...
    easily by using a :class:`~sklearn_fork.pipeline.Pipeline`::
...
is advised to use :class:`~sklearn_fork.model_selection.GridSearchCV` with
...
.. note::
    ...
    estimator used is :class:`~sklearn_fork.linear_model.Ridge` regression,
