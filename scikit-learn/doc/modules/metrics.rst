...
The :mod:`sklearn_fork.metrics.pairwise` submodule implements utilities to evaluate
...
.. currentmodule:: sklearn_fork.metrics.pairwise
...
(Note that the tf-idf functionality in ``sklearn_fork.feature_extraction.text``
...
:class:`~sklearn_fork.svm.SVC` with ``kernel="precomputed"``::

    >>> from sklearn_fork.svm import SVC
    >>> from sklearn_fork.metrics.pairwise import chi2_kernel
    >>> X = [[0, 1], [1, 0], [.2, .8], [.7, .3]]
    >>> y = [0, 1, 0, 1]
