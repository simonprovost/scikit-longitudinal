...
.. currentmodule:: sklearn_fork.inspection
...
The :mod:`sklearn_fork.inspection` module provides a convenience function
...
:func:`sklearn_fork.inspection.partial_dependence` function::
...
:func:`sklearn_fork.inspection.partial_dependence` gives the actual values
...
with a :class:`~sklearn_fork.ensemble.HistGradientBoostingRegressor`:.
...
The :mod:`sklearn_fork.inspection` module's :meth:`PartialDependenceDisplay.from_estimator`
