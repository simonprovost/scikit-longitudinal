...
:func:`~sklearn_fork.inspection.PartialDependenceDisplay.from_estimator` and
:class:`~sklearn_fork.inspection.PartialDependenceDisplay` support plotting on
...
See for example, :func:`~sklearn_fork.inspection.PartialDependenceDisplay.from_estimator
