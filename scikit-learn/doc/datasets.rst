...
The ``sklearn_fork.datasets`` package embeds some small toy datasets
...
Both loaders and fetchers functions return a :class:`~sklearn_fork.utils.Bunch`
...
For more information about Bunch object, see :class:`~sklearn_fork.utils.Bunch`.
