...
- |Efficiency| :class:`impute.SimpleImputer` is now faster with `object` dtype array.
  when `strategy='most_frequent'` in :class:`~sklearn_fork.impute.SimpleImputer`.
...
- |Fix| Raise error on
  :meth:`sklearn_fork.preprocessing.OneHotEncoder.inverse_transform`
