...
- The ``labels`` parameter to :func:`sklearn_fork.metrics.f1_score`,
  :func:`sklearn_fork.metrics.fbeta_score`,
  :func:`sklearn_fork.metrics.recall_score` and
  :func:`sklearn_fork.metrics.precision_score` has been extended.
...
- Provide an option for sparse output from
  :func:`sklearn_fork.metrics.pairwise.cosine_similarity`. By
