...
- |Fix| :func:`datasets.fetch_california_housing`,
  ...
  data was persisted using the deprecated ``sklearn_fork.externals.joblib``. This
...
:mod:`sklearn_fork.utils.sparsefuncs`
................................
...
- :class:`sklearn_fork.feature_extraction.text.HashingVectorizer`,
  :class:`sklearn_fork.feature_extraction.text.TfidfVectorizer`, and
  :class:`sklearn_fork.feature_extraction.text.CountVectorizer` |Fix|
...
- |MajorFeature| Add two new implementations of
  ...
  need to explicitly import ``enable_hist_gradient_boosting``::
    ...
    >>> # now you can import normally from sklearn_fork.ensemble
  ...
  .. note::
      ...
      anymore and you don't need to use `from sklearn_fork.experimental import
...
- |Efficiency| :class:`sklearn_fork.ensemble.GradientBoostingClassifier` and
  :class:`sklearn_fork.ensemble.GradientBoostingRegressor` now keep the
...
- |Fix| :func:`ensemble.partial_dependence` (and consequently the new
  version :func:`sklearn_fork.inspection.partial_dependence`) now takes sample
...
- |API| :func:`ensemble.partial_dependence` and
  ...
  :func:`inspection.partial_dependence<sklearn_fork.inspection.partial_dependence>`
  and
  :func:`inspection.plot_partial_dependence<sklearn_fork.inspection.plot_partial_dependence>`.
...
- |Fix| If ``input='file'`` or ``input='filename'``, and a callable is given as
  the ``analyzer``, :class:`sklearn_fork.feature_extraction.text.HashingVectorizer`,
  :class:`sklearn_fork.feature_extraction.text.TfidfVectorizer`, and
  :class:`sklearn_fork.feature_extraction.text.CountVectorizer` now read the data
...
- |MajorFeature| The `__repr__()` method of all estimators (used when calling
  ...
  :func:`sklearn_fork.set_config`. :pr:`11705` by :user:`Nicolas Hug
  <NicolasHug>`.
