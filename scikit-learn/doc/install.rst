...
.. raw:: html
       ...
       <div class="highlight"><pre><code
        ><span class="sk-expandable" data-packager="pip" data-os="linux" data-venv="">python3 -m venv sklearn_fork-venv</span
        ><span class="sk-expandable" data-packager="pip" data-os="windows" data-venv="">python -m venv sklearn_fork-venv</span
        ><span class="sk-expandable" data-packager="pip" data-os="mac" data-venv="">python -m venv sklearn_fork-venv</span
        ><span class="sk-expandable" data-packager="pip" data-os="linux" data-venv="">source sklearn_fork-venv/bin/activate</span
        ><span class="sk-expandable" data-packager="pip" data-os="mac" data-venv="">source sklearn_fork-venv/bin/activate</span
        ><span class="sk-expandable" data-packager="pip" data-os="windows" data-venv="">sklearn_fork-venv\Scripts\activate</span
        ...
        ><span class="sk-expandable" data-packager="conda">conda create -n sklearn_fork-env -c conda-forge scikit-learn</span
        ><span class="sk-expandable" data-packager="conda">conda activate sklearn_fork-env</span
       ></code></pre></div>
...
.. raw:: html
   ...
   <div class="highlight"><pre><code
      ...
      ><span class="sk-expandable" data-packager="pip" data-os="linux" data-venv="no">python3 -c "import sklearn_fork; sklearn_fork.show_versions()"</span
      ...
      ><span class="sk-expandable" data-packager="pip" data-venv="">python -c "import sklearn_fork; sklearn_fork.show_versions()"</span
      ...
      ><span class="sk-expandable" data-packager="pip" data-os="windows" data-venv="no">python -c "import sklearn_fork; sklearn_fork.show_versions()"</span
      ...
      ><span class="sk-expandable" data-packager="pip" data-os="mac" data-venv="no">python -c "import sklearn_fork; sklearn_fork.show_versions()"</span
      ...
      ><span class="sk-expandable" data-packager="conda">python -c "import sklearn_fork; sklearn_fork.show_versions()"</span
      ></code></pre></div>
  </div>
...
``python3-sklearn_fork`` (python modules), ``python3-sklearn_fork-lib`` (low-level
implementations and bindings), ``python3-sklearn_fork-doc`` (documentation).
...
.. prompt:: bash $
  ...
  sudo apt-get install python3-sklearn_fork python3-sklearn_fork-lib python3-sklearn_fork-doc
...
`daal4py <https://intelpython.github.io/daal4py/sklearn_fork.html>`_ documentation
for more details.
...
`AppData` folder structure under the user home directory, for instance::
    ...
    ERROR: Could not install packages due to an EnvironmentError: [Errno 2] No such file or directory: 'C:\\Users\\username\\AppData\\Local\\Packages\\PythonSoftwareFoundation.Python.3.7_qbz5n2kfra8p0\\LocalCache\\local-packages\\Python37\\site-packages\\sklearn_fork\\datasets\\tests\\data\\openml\\292\\api-v1-json-data-list-data_name-australian-limit-2-data_version-1-status-deactivated.json.gz'
