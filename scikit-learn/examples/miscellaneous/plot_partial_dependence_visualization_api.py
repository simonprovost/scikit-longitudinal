...
=========================================
The :class:`~sklearn_fork.inspection.PartialDependenceDisplay` object can be used
...
# :func:`~sklearn_fork.inspection.PartialDependenceDisplay.from_estimator` expects to plot
...
# :func:`~sklearn_fork.inspection.PartialDependenceDisplay.from_estimator` to change the
# color of the curve.
fig, ax = plt.subplots(figsize=(12, 6))
...
# :class:`~sklearn_fork.inspection.PartialDependenceDisplay` objects contain all the
...
# :func:`~sklearn_fork.inspection.PartialDependenceDisplay.plot` functions of
...
# :func:`~sklearn_fork.inspection.PartialDependenceDisplay.plot` function as a list,
