...
# -----------------------
#
# First, we will train a :class:`~sklearn_fork.ensemble.RandomForestClassifier`
...
# :class:`~sklearn_fork.ensemble.RandomForestClassifier` but train it using only
...
# :class:`~sklearn_fork.ensemble.RandomForestClassifier` which would have resulted
