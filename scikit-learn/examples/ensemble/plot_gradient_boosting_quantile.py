...
# %%
# Notice that :class:`~sklearn_fork.ensemble.HistGradientBoostingRegressor` is much
# faster than :class:`~sklearn_fork.ensemble.GradientBoostingRegressor` starting with
