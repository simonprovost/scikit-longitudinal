...
.. note::
    ...
    - See :func:`sklearn_fork.metrics.roc_curve` for further information about ROC
      curves.

    - See :func:`sklearn_fork.metrics.det_curve` for further information about
      DET curves.
...
# :func:`~sklearn_fork.metrics.det_curve` and the axis scale using
# :func:`scipy.stats.norm`.

import matplotlib.pyplot as plt
from sklearn_fork.metrics import DetCurveDisplay, RocCurveDisplay
