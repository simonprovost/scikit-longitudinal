...
:class:`~sklearn_fork.model_selection.LearningCurveDisplay` to easily plot learning
...
# %%
# The :meth:`~sklearn_fork.model_selection.LearningCurveDisplay.from_estimator`
...
import numpy as np
from sklearn_fork.model_selection import LearningCurveDisplay, ShuffleSplit
...
#
# The :class:`~sklearn_fork.model_selection.LearningCurveDisplay` class does not
# provide such information. We need to resort to the
# :func:`~sklearn_fork.model_selection.learning_curve` function instead and make
# the plot manually.
