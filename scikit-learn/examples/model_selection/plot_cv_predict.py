...
:func:`~sklearn_fork.model_selection.cross_val_predict` together with
:class:`~sklearn_fork.metrics.PredictionErrorDisplay` to visualize prediction
errors.
"""
...
# %%
# :func:`~sklearn_fork.model_selection.cross_val_predict` returns an array of the
...
# :class:`~sklearn_fork.metrics.PredictionErrorDisplay` to visualize the
# prediction errors.
#
...
# :func:`~sklearn_fork.model_selection.cross_val_predict` for visualization
...
# :func:`~sklearn_fork.model_selection.cross_val_predict`
...
# :func:`~sklearn_fork.model_selection.cross_val_score` or
# :func:`~sklearn_fork.model_selection.cross_validate` instead.
