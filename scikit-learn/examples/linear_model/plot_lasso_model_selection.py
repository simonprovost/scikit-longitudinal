...
# --------------------------------------------
# :class:`~sklearn_fork.linear_model.LassoLarsIC` provides a Lasso estimator that
...
# :class:`~sklearn_fork.preprocessing.StandardScaler`. In addition, we will
...
# cross-validation: :class:`~sklearn_fork.linear_model.LassoCV` and
# :class:`~sklearn_fork.linear_model.LassoLarsCV` that respectively solve the
...
# :class:`~sklearn_fork.linear_model.LassoCV`.
...
# ................................
# Let's start by making the hyperparameter tuning using
# :class:`~sklearn_fork.linear_model.LassoLarsCV`.
