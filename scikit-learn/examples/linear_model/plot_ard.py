...
# :class:`~sklearn_fork.linear_model.ARDRegression` and
# :class:`~sklearn_fork.linear_model.BayesianRidge`, then
# :class:`~sklearn_fork.preprocessing.PolynomialFeatures` should not introduce an
