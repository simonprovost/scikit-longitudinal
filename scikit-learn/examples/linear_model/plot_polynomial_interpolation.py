...
- :class:`~sklearn_fork.preprocessing.PolynomialFeatures` generates all monomials
...
- :class:`~sklearn_fork.preprocessing.SplineTransformer` generates B-spline basis
