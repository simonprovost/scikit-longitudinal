...
# :class:`~sklearn_fork.linear_model.LinearRegression` less efficient, i.e. we need
...
# :class:`~sklearn_fork.linear_model.QuantileRegressor` can be used in practice and
# give the intuition into the properties of the fitted models. Finally,
# we will compare the both :class:`~sklearn_fork.linear_model.QuantileRegressor`
# and :class:`~sklearn_fork.linear_model.LinearRegression`.
#
...
# %%
from sklearn_fork.linear_model import QuantileRegressor
...
# :class:`~sklearn_fork.linear_model.QuantileRegressor` and
# :class:`~sklearn_fork.linear_model.LinearRegression` are minimizing.
#
# Indeed, :class:`~sklearn_fork.linear_model.LinearRegression` is a least squares
# approach minimizing the mean squared error (MSE) between the training and
# predicted targets. In contrast,
# :class:`~sklearn_fork.linear_model.QuantileRegressor` with `quantile=0.5`
...
# :class:`~sklearn_fork.linear_model.QuantileRegressor` than
# :class:`~sklearn_fork.linear_model.LinearRegression`. In contrast to that, MSE is
# lower for :class:`~sklearn_fork.linear_model.LinearRegression` than
# :class:`~sklearn_fork.linear_model.QuantileRegressor`. These results confirms that
# MAE is the loss minimized by :class:`~sklearn_fork.linear_model.QuantileRegressor`
# while MSE is the loss minimized
# :class:`~sklearn_fork.linear_model.LinearRegression`.
#
