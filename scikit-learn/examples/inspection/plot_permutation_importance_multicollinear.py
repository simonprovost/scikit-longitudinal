...
breast cancer dataset using :func:`~sklearn_fork.inspection.permutation_importance`.
The :class:`~sklearn_fork.ensemble.RandomForestClassifier` can easily get about 97%
