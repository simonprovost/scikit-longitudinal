...
:class:`~sklearn_fork.covariance.EmpiricalCovariance`. It is unbiased, i.e. it
...
#   criterion), yielding the :class:`~sklearn_fork.covariance.LedoitWolf`
#   covariance estimate.
#
# * An improvement of the Ledoit-Wolf shrinkage, the
#   :class:`~sklearn_fork.covariance.OAS`, proposed by Chen et al. Its
