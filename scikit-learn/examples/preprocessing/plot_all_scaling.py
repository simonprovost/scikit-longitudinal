...
:class:`~sklearn_fork.preprocessing.QuantileTransformer` provides non-linear
transformations in which distances
between marginal outliers and inliers are shrunk.
:class:`~sklearn_fork.preprocessing.PowerTransformer` provides
...
# --------------
#
# :class:`~sklearn_fork.preprocessing.StandardScaler` removes the mean and scales
...
#
# :class:`~sklearn_fork.preprocessing.StandardScaler` therefore cannot guarantee
...
# ------------
#
# :class:`~sklearn_fork.preprocessing.MinMaxScaler` rescales the data set such that
# all feature values are in
# the range [0, 1] as shown in the right panel below. However, this scaling
# compresses all inliers into the narrow range [0, 0.005] for the transformed
# average house occupancy.
#
# Both :class:`~sklearn_fork.preprocessing.StandardScaler` and
# :class:`~sklearn_fork.preprocessing.MinMaxScaler` are very sensitive to the
# presence of outliers.
...
# ------------
#
# :class:`~sklearn_fork.preprocessing.MaxAbsScaler` is similar to
# :class:`~sklearn_fork.preprocessing.MinMaxScaler` except that the
...
# On positive only data, both :class:`~sklearn_fork.preprocessing.MinMaxScaler`
# and :class:`~sklearn_fork.preprocessing.MaxAbsScaler` behave similarly.
# :class:`~sklearn_fork.preprocessing.MaxAbsScaler` therefore also suffers from
...
# :class:`~sklearn_fork.preprocessing.RobustScaler`
...
# ----------------
#
# :class:`~sklearn_fork.preprocessing.PowerTransformer` applies a power
...
# methods. By default, :class:`~sklearn_fork.preprocessing.PowerTransformer` applies
...
# ------------------------------------
#
# :class:`~sklearn_fork.preprocessing.QuantileTransformer` applies a non-linear
...
#
# :class:`~sklearn_fork.preprocessing.RobustScaler` and
# :class:`~sklearn_fork.preprocessing.QuantileTransformer` are robust to outliers in
...
# :class:`~sklearn_fork.preprocessing.RobustScaler`,
# :class:`~sklearn_fork.preprocessing.QuantileTransformer` will also automatically
...
# ----------
#
# The :class:`~sklearn_fork.preprocessing.Normalizer` rescales the vector for each
