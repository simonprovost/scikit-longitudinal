...
# :func:`sklearn_fork.compose.make_column_selector` gives this possibility.
...
from sklearn_fork.compose import make_column_selector as selector
...
# :class:`~sklearn_fork.model_selection.RandomizedSearchCV`. This
...
# :class:`~sklearn_fork.model_selection.GridSearchCV` but the cartesian product of
