...
:class:`~sklearn_fork.compose.TransformedTargetRegressor`. We use two examples
...
from sklearn_fork.metrics import median_absolute_error, r2_score
...
# :class:`~sklearn_fork.linear_model.RidgeCV` model.
f, (ax0, ax1) = plt.subplots(1, 2)
