...
the :class:`sklearn_fork.preprocessing.SplineTransformer` class and its
...
# :func:`sklearn_fork.preprocessing.KBinsDiscretizer` instead to re-bin the number
...
# :class:`~sklearn_fork.neural_network.MLPRegressor` with one or two hidden layers
