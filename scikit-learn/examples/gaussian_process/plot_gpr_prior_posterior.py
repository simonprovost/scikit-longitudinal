...
:class:`~sklearn_fork.gaussian_process.GaussianProcessRegressor` with different
...
# :class:`~sklearn_fork.gaussian_process.GaussianProcessRegressor` model and will
...
def plot_gpr_samples(gpr_model, n_samples, ax):
    ...
    gpr_model : `GaussianProcessRegressor`
        A :class:`~sklearn_fork.gaussian_process.GaussianProcessRegressor` model.
    n_samples : int
...
# Dot-product kernel
# ..................
from sklearn_fork.gaussian_process.kernels import ConstantKernel, DotProduct
