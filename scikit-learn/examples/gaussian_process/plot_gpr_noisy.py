...
:class:`~sklearn_fork.gaussian_process.kernels.WhiteKernel` to estimate the noise
...
# :class:`~sklearn_fork.gaussian_process.GaussianProcessRegressor`
# using an additive kernel adding a
# :class:`~sklearn_fork.gaussian_process.kernels.RBF` and
# :class:`~sklearn_fork.gaussian_process.kernels.WhiteKernel` kernels.
# The :class:`~sklearn_fork.gaussian_process.kernels.WhiteKernel` is a kernel that
# will able to estimate the amount of noise present in the data while the
# :class:`~sklearn_fork.gaussian_process.kernels.RBF` will serve at fitting the
...
from sklearn_fork.gaussian_process.kernels import RBF, WhiteKernel
...
# :class:`~sklearn_fork.gaussian_process.kernels.RBF` with a
# larger `length_scale` and the
# :class:`~sklearn_fork.gaussian_process.kernels.WhiteKernel`
