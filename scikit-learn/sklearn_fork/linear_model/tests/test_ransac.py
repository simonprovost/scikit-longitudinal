...
from sklearn_fork.linear_model import LinearRegression, OrthogonalMatchingPursuit, RANSACRegressor, Ridge
from sklearn_fork.linear_model._ransac import _dynamic_max_trials
...
def test_base_estimator_deprecated():
    ...
    err_msg = "`base_estimator` was renamed to `estimator` in version 1.1 and will be removed in 1.3."
