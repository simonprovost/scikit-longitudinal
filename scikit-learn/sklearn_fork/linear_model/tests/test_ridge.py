...
from sklearn_fork.linear_model._ridge import (
    _check_gcv_mode,
    _RidgeGCV,
    _solve_cholesky,
...
from sklearn_fork.metrics import get_scorer, make_scorer, mean_squared_error
from sklearn_fork.model_selection import GridSearchCV, GroupKFold, KFold, LeaveOneOut, cross_val_predict
from sklearn_fork.preprocessing import minmax_scale
from sklearn_fork.utils import _IS_32BIT, check_random_state
...
@pytest.mark.parametrize("solver", ["cholesky", "lsqr", "sparse_cg", "svd", "sag", "saga", "lbfgs"])
