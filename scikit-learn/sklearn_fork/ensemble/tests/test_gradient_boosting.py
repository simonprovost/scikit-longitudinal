...
from sklearn_fork.exceptions import DataConversionWarning, NotFittedError
...
from sklearn_fork.utils._testing import assert_array_almost_equal, assert_array_equal, skip_if_32bit
...
def test_gradient_boosting_with_init_pipeline():
    ...
    invalid_nu = 1.5
    err_msg = f"The 'nu' parameter of NuSVR must be a float in the range (0.0, 1.0]. Got {invalid_nu} instead."
