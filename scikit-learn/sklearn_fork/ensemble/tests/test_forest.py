"""
Testing for the forest module (sklearn_fork.ensemble.forest).
"""
...
from sklearn_fork.metrics import explained_variance_score, f1_score, mean_poisson_deviance, mean_squared_error
...
from sklearn_fork.tree._classes import SPARSE_SPLITTERS
...
def test_mse_criterion_object_segfault_smoke_test(Forest):
    ...
    from sklearn_fork.tree._criterion import MSE
