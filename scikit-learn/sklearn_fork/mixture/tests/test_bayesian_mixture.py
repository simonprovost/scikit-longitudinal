...
from sklearn_fork.mixture._bayesian_mixture import _log_dirichlet_norm, _log_wishart_norm
from sklearn_fork.mixture.tests.test_gaussian_mixture import RandomData
