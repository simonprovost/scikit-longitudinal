...
def _reporter_random_forest(
    system: RandomForestClassifier, X_test: pd.DataFrame
) -> dict[str, Any]:
    """
    Reports the results of the fitted RandomForestClassifier algorithm on the test data.

    Args:
        system (RandomForestClassifier): The fitted RandomForestClassifier algorithm.
