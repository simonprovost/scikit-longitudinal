...
def _reporter_lexico_deep_forest_gridsearch(system: GridSearchCV, X_test: pd.DataFrame, opt_metric: str) -> dict:
    """
    Reporter function for LexicoDeepForestClassifier with GridSearchCV.
...
class Launcher:
    ...
    def launch_experiment(self):
            ...
            ('classifier', LexicoDeepForestClassifier(
                longitudinal_base_estimators=[
                    LongitudinalEstimatorConfig(
                        ...
                        count=2,
                        hyperparameters={
                            "n_estimators": 100,  # gonna be overwritten by grid search
                            "threshold_gain": 0.0015,  # gonna be overwritten by grid search
                            "max_features": sqrt_p,  # gonna be overwritten by grid search
                            "random_state": self.args.random_state,
        ...
        param_grid = {
            'classifier__longitudinal_base_estimators': [
                [
                    LongitudinalEstimatorConfig(
                        classifier_type=LongitudinalClassifierType.LEXICO_RF,
                        count=2,
        ...
        experiment = ExperimentEngine(
            ...
            system_reporter=lambda system, X_test: _reporter_lexico_deep_forest_gridsearch(
                system,
                X_test,
