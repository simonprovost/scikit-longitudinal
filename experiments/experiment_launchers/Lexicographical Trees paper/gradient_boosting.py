...
def _reporter_gradient_boosting(system: GradientBoostingClassifier, X_test: pd.DataFrame) -> dict[str, Any]:
    """
    Reports the results of the fitted GradientBoostingClassifier algorithm on the test data.

    Args:
        system (GradientBoostingClassifier): The fitted GradientBoostingClassifier algorithm.
    ...
    def launch_experiment(self):
        experiment = ExperimentEngine(
            ...
            system_hyperparameters={
                "custom_system": GradientBoostingClassifier,
            },
            system_reporter=_reporter_gradient_boosting,
        )
