...
def _reporter_decision_tree(system: DecisionTreeClassifier, X_test: pd.DataFrame) -> dict[str, Any]:
    """
    Reports the results of the fitted DecisionTreeClassifier algorithm on the test data.

    Args:
        system (DecisionTreeClassifier): The fitted DecisionTreeClassifier algorithm.
    ...
    def launch_experiment(self):
        experiment = ExperimentEngine(
            ...
            system_hyperparameters={
                "custom_system": DecisionTreeClassifier,
                "class_weight": "balanced",
            },
            system_reporter=_reporter_decision_tree,
        )
