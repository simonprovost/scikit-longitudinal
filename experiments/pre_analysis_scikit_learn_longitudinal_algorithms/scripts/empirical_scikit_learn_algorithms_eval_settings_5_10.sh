...
#SBATCH --job-name=pre_analysis_sklearn_5_10    # Job name
#SBATCH --output=pre_analysis_sklearn_5_10.log  # Standard output and error log
...
python experiments/pre_analysis_scikit_learn_longitudinal_algorithms/nested_cross_validation_scikit_learn_algorithms_settings_5_10.py
